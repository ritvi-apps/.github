...
Small, focused apps for India. Mostly React Native and Expo, with RevenueCat for
purchases and Firebase on the backend.

| App | What it does | Android | iOS | Web |
|---|---|:--|:--|:--|
| **Chitragupt** (चित्रगुप्त) | Household tax review for salaried Indian filers. Form 16 in, both regimes compared side by side, refund out. | 🔒 Internal testing | – | 🟢 **[chitragupt.ai](https://chitragupt.ai)** |
...
The 🧪 links above are open to anyone — no invite needed. Restricted tracks (🔒)
go by email, so send the address on your device: your **Google account** email
for Android, your **Apple ID** email for iOS.

---

Built by **[Ritesh Firodiya](https://github.com/ritesh-firodiya)** · Privacy policies: **[ritvi-apps.github.io/legal](https://ritvi-apps.github.io/legal/)**
